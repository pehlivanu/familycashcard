    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            .authorizeHttpRequests(request -> request
                .requestMatchers("/cashcards/**")    // Configure security for all /cashcards endpoints
                .hasRole("CARD-OWNER"))              // Only users with CARD-OWNER role can access
            .httpBasic(Customizer.withDefaults())    // Enable HTTP Basic authentication
            .csrf(csrf -> csrf.disable());           // Disable CSRF protection for simplicity in this demo
