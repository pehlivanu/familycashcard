 ...
 * 
 * <p>
 * This class bootstraps and launches the Spring Boot application. The
 * {@code @SpringBootApplication} annotation enables the following features:
 * <ul>
...
public class CashcardApplication {
	 ...
	 * 
	 * <p>
	 * This method delegates to Spring Boot's {@link SpringApplication#run} method to bootstrap the
	 * application. It sets up the default configuration, starts the embedded server, and performs
	 * class path scanning.
	 * </p>
	 * 
